...
// =============================================================================
// CORNERSTONE/INCLUDES/ELEMENTS/MIXINS_ELEMENTS/SEARCH-MODAL.PHP
// -----------------------------------------------------------------------------
// V2 element mixins.
// =============================================================================
...
function x_controls_element_search_modal( $adv = false ) {

  include( dirname( __FILE__ ) . '/../mixins_setup/_.php' );

  $cond_adv           = array( 'adv' => $adv );
  $search_args        = array( 't_pre' => __( 'Search', '__x__' ) );

  $toggle_adv         = x_bar_module_settings_anchor( 'toggle', $cond_adv );
  $modal_adv          = $cond_adv;
  $search_adv         = x_bar_module_settings_search( 'modal', array_merge( $search_args, $cond_adv ) );
  ...
  $search_std_content = x_bar_module_settings_search( 'modal', array( 'inc_t_pre' => true, 'group' => $group_std_content ) );
  $search_std_design  = x_bar_module_settings_search( 'modal', array( 'inc_t_pre' => true, 'group' => $group_std_design ) );
...
function x_control_groups_element_search_modal( $adv = false ) {

  $toggle = x_bar_module_settings_anchor( 'toggle' );
  $search = x_bar_module_settings_search( 'modal', array( 't_pre' => __( 'Search', '__x__' ) ) );
  ...
  if ( $adv ) {
    ...
    $control_groups = x_control_groups_std( array( 'group_title' => __( 'Search Modal', '__x__' ) ) );
...
function x_values_element_search_modal( $settings = array() ) {
