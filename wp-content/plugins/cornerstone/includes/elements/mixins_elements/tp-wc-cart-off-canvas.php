...
// =============================================================================
// CORNERSTONE/INCLUDES/ELEMENTS/MIXINS_ELEMENTS/TP-WC-CART-OFF-CANVAS.PHP
// -----------------------------------------------------------------------------
// V2 element mixins.
// =============================================================================
...
function x_controls_element_tp_wc_cart_off_canvas( $adv = false ) {
...
function x_control_groups_element_tp_wc_cart_off_canvas( $adv = false ) {
  ...
  if ( $adv ) {
    ...
    $control_groups = x_control_groups_std( array( 'group_title' => __( 'Cart Off Canvas', '__x__' ) ) );
...
function x_values_element_tp_wc_cart_off_canvas( $settings = array() ) {
